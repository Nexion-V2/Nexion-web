...
export default function ReplyPreview() {
  ...
  const { images, videos, audios, files } = getAttachmentTypes(
    attachments as any
  );
  ...
  return (
    <motion.div
      ...
      className="bg-[#1c1c1c] border-l-4 border-blue-500 px-4 py-3 rounded-r-md"
    >
        ...
        <div className="flex-1 min-w-0">
          ...
          {replyingTo.content?.text && (
            <div className="text-xs text-gray-300">
              <ExpandableText text={replyingTo.content.text} />
            </div>
          )}
